...
(function initStrengthIndicator() {
    ...
    const passwordToggleDiv = passwordField.parentElement;
...
(function initMatchIndicator() {
    ...
    const confirmToggleDiv = confirmField.parentElement;
